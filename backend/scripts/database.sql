...
INSERT INTO informes (
    oamp, usu_cedula, evi_id, eviin_id,
...
-- Informe para evidencia grupal 1
(2001, 1010219918, 1, NULL, 'Enero', 3, 1000000, 255000, 255000, 745000, 20, 3, 3, 17),

-- Informe para evidencia grupal 2
(2001, 1001234567, 2, NULL, 'Febrero', 3, 1000000, 270000, 525000, 475000, 20, 3, 6, 14),

-- Informe para evidencia grupal 3
(2001, 1002345678, 3, NULL, 'Marzo', 3, 1000000, 285000, 810000, 190000, 20, 3, 9, 11);
...
(2001, 1003456789, NULL, 1, 'Enero', 2, 1000000, 180000, 180000, 820000, 20, 2, 2, 18),

-- Informe evidencia individual 2
(2001, 1004567890, NULL, 2, 'Febrero', 2, 1000000, 190000, 370000, 630000, 20, 2, 4, 16),

-- Informe evidencia individual 3
(2001, 1005678901, NULL, 3, 'Marzo', 2, 1000000, 170000, 540000, 460000, 20, 2, 6, 14);
